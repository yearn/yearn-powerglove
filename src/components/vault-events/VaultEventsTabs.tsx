...
const tabTriggerClassName =
  'shrink-0 rounded-none border-b-2 border-transparent px-5 py-2 text-sm text-muted-foreground data-[state=active]:border-[#0657f9] data-[state=active]:bg-transparent data-[state=active]:text-foreground data-[state=active]:shadow-none'

export const VaultEventsTabs: React.FC<VaultEventsTabsProps> = React.memo(
  ({ vaultChainId, vaultDetails, panelHeaderStickyTop = 54 }) => {
